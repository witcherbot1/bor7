...
let handler = async (_0x4f9075, {
  ...
  if (!_0x378db0 && !(_0x4f9075.quoted && _0x4f9075.quoted.text)) {
    throw "*مرحبا بك انا جي بي تي ذكاء اصطناعي او متحدث الي يمكنك انت تكتب سؤالك ⚡*\n\n*مثال:*\n*" + (_0x8563f + _0x4d8ac9) + " اكتب رمز JS*\n*ملاحظة الأمر هذا يمكنه قرأة الصور أيضا*\n";
  }
  try {
    ...
    const _0x42a6e7 = _0x30b50b ? "https://shizoapi.onrender.com/api/ai/gpt?apikey=" + _0x1429fb + "&url=" + _0x30b50b : "https://kurosaki-api-41c2cc13d140.herokuapp.com/api/chatgpt?q=" + _0x1429fb + "&url=";
...
handler.help = ["gpt"];
handler.tags = ['AI'];
handler.command = ["AI_gpt", "ai_gpt", "gptai", 'جي_بي_تي', "gpt"];
